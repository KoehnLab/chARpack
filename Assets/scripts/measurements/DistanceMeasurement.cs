...
public class DistanceMeasurement : MonoBehaviour
{
    ...
    {
        var startAtom = GlobalCtrl.Singleton.Dict_curMolecules.ContainsKey(mol1_id) ? GlobalCtrl.Singleton.Dict_curMolecules[mol1_id].atomList.ElementAtOrNull(atom1_id, null) : null;
        var endAtom = GlobalCtrl.Singleton.Dict_curMolecules.ContainsKey(mol1_id) ? GlobalCtrl.Singleton.Dict_curMolecules[mol1_id].atomList.ElementAtOrNull(atom1_id, null) : null;
