    ...
    public class mySlider : MonoBehaviour, IMixedRealityPointerHandler, IMixedRealityFocusHandler, IMixedRealityTouchHandler
    {
        ...
        public float SliderValue
        {
            ...
            set
            {
                ...
                sliderValue = value;
                UpdateUI();
                OnValueUpdated.Invoke(new mySliderEventData(oldSliderValue, value, ActivePointer, this));
            }
        }
        ...
        [Header("Events")]
        public mySliderEvent OnValueUpdated = new mySliderEvent();
        public mySliderEvent OnInteractionStarted = new mySliderEvent();
        public mySliderEvent OnInteractionEnded = new mySliderEvent();
        public mySliderEvent OnHoverEntered = new mySliderEvent();
        public mySliderEvent OnHoverExited = new mySliderEvent();
        #endregion
        ...
        protected virtual void Start()
        {
            ...
            InitializeSliderThumb();
            OnValueUpdated.Invoke(new mySliderEventData(sliderValue, sliderValue, null, this));
        }
        ...
        private void EndInteraction()
        {
            ...
            {
                OnInteractionEnded.Invoke(new mySliderEventData(sliderValue, sliderValue, ActivePointer, this));
            }
            ActivePointer = null;
        }
        ...
        {
            OnHoverEntered.Invoke(new mySliderEventData(sliderValue, sliderValue, eventData.Pointer, this));
        }

        public void OnFocusExit(FocusEventData eventData)
        {
            OnHoverExited.Invoke(new mySliderEventData(sliderValue, sliderValue, eventData.Pointer, this));
        }
        #endregion
        ...
        public void OnPointerDown(MixedRealityPointerEventData eventData)
        {
            if (ActivePointer == null && !eventData.used)
            {
                ...
                {
                    OnInteractionStarted.Invoke(new mySliderEventData(sliderValue, sliderValue, ActivePointer, this));
                }
