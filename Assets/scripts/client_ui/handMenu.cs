...
namespace chARpack
{
    ...
    public class handMenu : myScrollObject
    {
        ...
        public void setVisuals()
        {
            ...
            {
                ChainModeIndicator.GetComponent<MeshRenderer>().material.color = ColorPalette.ColorPalette.activeIndicatorColor;
                MeasurementModeIndicator.GetComponent<MeshRenderer>().material.color = ColorPalette.ColorPalette.inactiveIndicatorColor;
            }
            else if (GlobalCtrl.Singleton.currentInteractionMode == GlobalCtrl.InteractionModes.MEASUREMENT)
            {
                ChainModeIndicator.GetComponent<MeshRenderer>().material.color = ColorPalette.ColorPalette.inactiveIndicatorColor;
                MeasurementModeIndicator.GetComponent<MeshRenderer>().material.color = ColorPalette.ColorPalette.activeIndicatorColor;
            }
            else
            {
                ChainModeIndicator.GetComponent<MeshRenderer>().material.color = ColorPalette.ColorPalette.inactiveIndicatorColor;
