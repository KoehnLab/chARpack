    ...
    public void setColorPalette(ColorScheme color)
    {
        ...
        switch (color)
        {
            case ColorScheme.DARKBLUE:
                ...
                ColorPalette.activeIndicatorColor = chARpackColors.orange;
                break;
            case ColorScheme.TURQUOISE:
                ...
                ColorPalette.activeIndicatorColor = chARpackColors.orangered;
                break;
            case ColorScheme.GOLD:
                ...
                ColorPalette.activeIndicatorColor = chARpackColors.lightblue;
                break;
            case ColorScheme.MONOCHROME:
                ...
                ColorPalette.activeIndicatorColor = chARpackColors.white;
                break;
            ...
            case ColorScheme.VIOLET:
                ...
                ColorPalette.activeIndicatorColor = chARpackColors.yelloworange;
                break;
            ...
            case ColorScheme.GREEN:
                ...
                ColorPalette.activeIndicatorColor = chARpackColors.gold;
                break;
        }
    }
