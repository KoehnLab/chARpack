...
namespace chARpack
{
    ...
    public class DebugWindow : myScrollObject
    {
        ...
        public void setVisual(GameObject indicator, bool value)
        {
            if (value)
            {
                indicator.GetComponent<MeshRenderer>().material.color = ColorPalette.ColorPalette.activeIndicatorColor;
            }
            else
            {
                indicator.GetComponent<MeshRenderer>().material.color = ColorPalette.ColorPalette.inactiveIndicatorColor;
            }
        }
