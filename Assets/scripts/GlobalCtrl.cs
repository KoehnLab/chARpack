...
public class GlobalCtrl : MonoBehaviour
{
    ...
    {
        if (term_id >= List_curMolecules[mol_id].bondTerms.Count)
        {
            return false;
        }
    ...
    {
        if (term_id >= List_curMolecules[mol_id].angleTerms.Count)
        {
            return false;
        }
    ...
    {
        if (term_id >= List_curMolecules[mol_id].torsionTerms.Count)
        {
            return false;
        }
