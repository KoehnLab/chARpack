...
sealed public class MeshBuilder : System.IDisposable
{
    ...
    public void BuildIsosurface(ComputeBuffer voxels, float target, Vector3 scale)
    ...
    void RunCompute(ComputeBuffer voxels, float target, Vector3 scale)
    {
        ...
        _compute.SetVector3("Scale", scale);
        ...
        // Bounding box
        var ext = new Vector3(_grids.x * scale.x, _grids.y * scale.y, _grids.z * scale.z);
